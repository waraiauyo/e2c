    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <h2 className="text-3xl font-bold tracking-tight">Gestion des CLAS</h2>
          <p className="text-muted-foreground">
            Visualisez et gérez les centres, leur capacité et les équipes pédagogiques.
          </p>
        </div>
              ...
              <TableRow>
                <TableCell colSpan={5} className="h-32 text-center">
                  <div className="flex flex-col items-center justify-center text-muted-foreground space-y-2">
                    ...
                    <p>Aucun CLAS configuré pour le moment.</p>
                  </div>
                </TableCell>
              </TableRow>
            ) : (
              clasList.map((clas) => (
                <TableRow key={clas.id} className="group">
                  ...
                  <TableCell className="text-center">
                    {clas.capacity ? (
                      <span className="font-mono font-medium">{clas.capacity}</span>
                    ) : (
