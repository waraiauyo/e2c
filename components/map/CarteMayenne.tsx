...
import { selectClasForMap, selectClasStatus } from "@/lib/redux/features/clas/selectors";
...
// Config globale Leaflet (Side effect unique)
    ...
    <div className="relative w-full h-full">
      ...
      >
        ...
        {mapMarkers.map((marker) => (
          <ClasMarker key={marker.id} position={marker.position} infos={marker.infos} />
        ))}
